...
CREATE TABLE tbladmin (
    ID int(10) NOT NULL, AdminName varchar(120) DEFAULT NULL, UserName varchar(120) DEFAULT NULL, MobileNumber bigint(10) DEFAULT NULL, Email varchar(200) DEFAULT NULL, Password varchar(200) DEFAULT NULL, AdminRegdate timestamp NULL DEFAULT current_timestamp()
...
CREATE TABLE tblclass (
    ID int(5) NOT NULL, ClassName varchar(50) DEFAULT NULL, Section varchar(20) DEFAULT NULL, CreationDate timestamp NULL DEFAULT current_timestamp(), Faculty varchar(50) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
INSERT INTO
    tblclass (
        ID, ClassName, Section, CreationDate
    )
VALUES (
...
CREATE TABLE tblfaculty (
    ID int(5) NOT NULL, FacultyName varchar(200) DEFAULT NULL, FacultyEmail varchar(200) DEFAULT NULL, Department varchar(100) DEFAULT NULL, Gender varchar(50) DEFAULT NULL, DOB date DEFAULT NULL, FacultyID varchar(200) DEFAULT NULL, ContactNumber bigint(10) DEFAULT NULL, UserName varchar(200) DEFAULT NULL, Password varchar(200) DEFAULT NULL, DateofAdmission timestamp NULL DEFAULT current_timestamp()
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
-- drop table hod;
CREATE TABLE hod (
    department varchar(3) NOT NULL UNIQUE, HOD varchar(50) default "NA", primary key (department)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;

INSERT INTO hod (department) VALUES ('CSE'), ('ECE'), ('BS');
...
CREATE TABLE tblpublicnotice (
    ID int(5) NOT NULL, NoticeTitle varchar(200) DEFAULT NULL, NoticeMessage mediumtext DEFAULT NULL, CreationDate timestamp NULL DEFAULT current_timestamp()
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
INSERT INTO
    tblpublicnotice (
        ID, NoticeTitle, NoticeMessage, CreationDate
    )
VALUES (
...
INSERT INTO
    tblstudent (
        ID, StudentName, StudentEmail, StudentClass, Gender, DOB, StuID, FatherName, MotherName, ContactNumber, AltenateNumber, Address, UserName, Password, Image, DateofAdmission
    )
VALUES (
...
-- drop table info;
CREATE TABLE info (
    studentID varchar(50) NOT NULL, courseName varchar(50) NOT NULL, marks int(3) DEFAULT 0, attendance int(3) DEFAULT 0, primary key (studentID, courseName)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
--
ALTER TABLE tblpublicnotice ADD PRIMARY KEY (ID);
